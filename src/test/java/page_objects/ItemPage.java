...
public class ItemPage {
    ...
    public ItemPage(String waitTime) {
    ...
    public boolean compareItems(String itemName, String gameName, String heroName, String rarity) {
        ...
        if(util.setPresenceWait(ITEM_NAME).getText().equals(itemName) &&
                util.setPresenceWait(ITEM_GAME_NAME).getText().equals(gameName) &&
                util.setPresenceWait(ITEM_RARITY).getText().contains(rarity) &&
                util.setPresenceWait(ITEM_HERO).getText().contains(heroName)) {
            result = true;
        }
